...
const clubLeft = (board) => {
  ...
  if (boards.clubLeft1Obj.posY < 0) {
    ...
    board[boards.clubLeft1Obj.posX][boards.clubLeft1Obj.posY + 5] = boards.nullObj;
...
const clubRight = (board) => {
  boards.clubRight1Obj.posY++;
  if (boards.clubRight1Obj.posY > board[0].length - 1) {
    boards.clubRight1Obj.posY = board[0].length - 1;
  } else {
    board[boards.clubRight1Obj.posX][boards.clubRight1Obj.posY] = boards.clubRight1Obj;
    board[boards.clubRight1Obj.posX][boards.clubRight1Obj.posY - 5] = boards.nullObj;
